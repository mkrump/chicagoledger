...
from src.handler import call
from src.ocd_api import BillsRequestParams
from tests.test_config import EXAMPLE_INTRODUCTIONS


# TODO maybe try to simplify this test / setup
@patch('src.handler.today')
@patch('src.handler.TwitterBot.tweet_introductions')
@patch('src.handler.Bills.insert')
@patch('src.handler.Bills.exists')
@patch('src.handler.BillsEndpoint.get_bills')
